...
public class PlayUnitMirrorUpInLeft extends PlayUnit {

	public PlayUnitMirrorUpInLeft() {
		monsterDie = false;
		playUnitId = 4;
		iCordinat = 0;
		jCordinat = 0;
	...
	public PlayUnitMirrorUpInLeft(boolean monsterDie, int playUnitId, int iCordinat, int jCordinat, boolean upIn,
	...
	public String toString() {
		return super.toString() + "PlayUnitMirrowUpInLeft []";
	}
