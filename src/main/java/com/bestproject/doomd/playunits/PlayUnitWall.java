...
public class PlayUnitWall extends PlayUnit {
	...
	public PlayUnitWall(boolean monsterDie, int playUnitId, int iCordinat, int jCordinat, boolean upIn,
	...
	public String toString() {
		return super.toString()+"PlayUnitWall []";
	}
