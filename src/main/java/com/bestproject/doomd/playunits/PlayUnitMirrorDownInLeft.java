...
public class PlayUnitMirrorDownInLeft extends PlayUnit {

	public PlayUnitMirrorDownInLeft() {
		monsterDie = false;
		playUnitId = 2;
		iCordinat = 0;
		jCordinat = 0;
	...
	public PlayUnitMirrorDownInLeft(boolean monsterDie, int playUnitId, int iCordinat, int jCordinat, boolean upIn,
	...
	public void setPlayUnitName() {
		...
		if (downIn && leftOut || leftIn && downOut) {
			name = "MirrorLDL";
		}
	}
	...
	public String toString() {
		return super.toString() + "PlayUnitMirrowDownInLeft []";
	}
